export const candidateData = [
    ...
    {
      candidateName: 'Prashant Malviya',
      candidateDetails: {
        images: '',
    ...
    {
      candidateName: 'Suhasee Talreja',
      candidateDetails: {
        images: '',
        emailId: 'suhaseetalreja14@gmail.com',
        'class': 'BCA',
        address: 'Vivekanand complex,Harda',
        city: 'Harda',
        fatherName: 'Sunil Talreja',
        motherName: 'Komal Talreja',
        hobbies: 'Dancing',
        mobileNo: '8821061133',
        collegeName: 'SSISM,Sandalpur'
      }
